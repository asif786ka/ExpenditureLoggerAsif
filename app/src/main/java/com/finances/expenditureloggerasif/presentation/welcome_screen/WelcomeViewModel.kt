package com.finances.expenditureloggerasif.presentation.welcome_screen
...
import com.finances.expenditureloggerasif.domain.model.CurrencyModel
import com.finances.expenditureloggerasif.domain.usecase.GetCurrencyUseCase
import com.finances.expenditureloggerasif.domain.usecase.write_database.InsertAccountsUseCase
import com.finances.expenditureloggerasif.domain.usecase.write_datastore.EditCurrencyUseCase
import com.finances.expenditureloggerasif.domain.usecase.write_datastore.EditOnBoardingUseCase
import com.finances.expenditureloggerasif.presentation.home_screen.Account
import com.finances.expenditureloggerasif.presentation.welcome_screen.components.OnBoardingPage
